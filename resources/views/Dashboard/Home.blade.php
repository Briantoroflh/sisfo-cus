                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">3,782</div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">3,621</div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Fani Puspita</td>
                                            <td>fani@example.com</td>
                                            <td>30/04/2025</td>
                                        </tr>
                                        <tr>
                                            <td>Galih Pratama</td>
                                            <td>galih@example.com</td>
                                            <td>30/04/2025</td>
                                        </tr>
                                        <tr>
                                            <td>Hana Wijaya</td>
